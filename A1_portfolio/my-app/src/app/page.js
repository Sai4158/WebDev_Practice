...
export default function Home() {
  return (
    <div>
      <main className="pt-20 pb-2 px-4">
        <div className="flex items-center justify-center min-h-screen">
          <div className="relative w-full max-w-5xl bg-opacity-40 p-10 rounded-lg shadow-lg overflow-hidden bg-black z-20">
            {/* Background Image */}
            ...
            {/* Content Section */}
            <div className="relative flex flex-col md:flex-row items-center justify-center w-full h-full z-20">
